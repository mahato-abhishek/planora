        ...
        <div className=" h-50  col-span-4 space-y-4">
          ...
          <div className="fit w-full  space-y-1">
            ...
            {projects.map((project) => (
              <div
                key={project.id}
                className={`${geistSans.className} border px-4 h-full  w-full grid grid-cols-6 gap-2 items-center  bg-mist-100 dark:border-mist-700 border-mist-300 dark:bg-mist-950  `}
              >
                <p
                ...
                <p className="flex items-center justify-left gap-1 h-full py-2 col-span-1  dark:border-mist-700 border-mist-300 text-sm">
        ...
        <div className=" h-50 space-y-4 col-span-5">
          ...
          <div className="fit w-full  space-y-1">
            ...
            {tasks.map((task) => (
              <div
                key={task.id}
                className={`${geistSans.className} border px-4 h-full  w-full grid grid-cols-9 gap-2 items-center  bg-mist-100 dark:border-mist-700 border-mist-300 dark:bg-mist-950`}
              >
                <p
                  className={`${geistMono.className} text-left h-full py-2 col-span-2 border-r dark:border-mist-700 border-mist-300 font-medium`}
                >
